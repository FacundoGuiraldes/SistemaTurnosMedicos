...
### Fixed
- [fix/rc6-tarjetas-crc-ajustes] Agregar responsabilidad 'Autorizar sobreturno' en clase Doctor y creación de tarjeta LlegadaPaciente con responsabilidades de registro de presencia física. PR: [#XX](https://github.com/FacundoGuiraldes/SistemaTurnosMedicos/pull/XX) - @carolabenvenuto-uces (Diseñador de Tarjetas CRC)
