...
### Fixed
- [fix/rc5-prompt-ia-disenador] Corrección del formato del prompt en disenador-tarjetas-crc.md envolviéndolo en triple backtick para reproducibilidad. PR: [#XX](https://github.com/FacundoGuiraldes/SistemaTurnosMedicos/pull/XX) - @carolabenvenuto-uces (Diseñador de Tarjetas CRC)
