...
### Added
- [cursor/esp-extension-ocp-add-anexo-ocp-b591] Aplicación del principio Abierto/Cerrado (OCP) sobre el diseño del Sistema de Turnos Médicos. Se agregaron el anexo técnico, el diagrama de clases en PlantUML/PNG y la auditoría de IA asociada. PR: pendiente - @FacundoGuiraldes (Especialista en OCP)
