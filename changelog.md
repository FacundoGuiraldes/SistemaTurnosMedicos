...
- [feature/analista-...] Análisis de requerimientos: RFs, RNFs y NotebookLM.
  PR: [#1](https://github.com/FacundoGuiraldes/SistemaTurnosMedicos/pull/N) - @FacundoGuiraldes (Analista de Requerimientos)
- [feature/modelador-...] Casos de uso: 5 CUs del dominio del consultorio.
  PR: [#4](https://github.com/FacundoGuiraldes/SistemaTurnosMedicos/pull/N) - @caterinacerdan (Modelador de Casos de Uso)
- [feature/diseniador-...] Diagrama de clases inicial en Excalidraw + PNG.
  PR: [#6](https://github.com/FacundoGuiraldes/SistemaTurnosMedicos/pull/N) - @carolabenvenuto-uces (Diseñador de Clases Iniciales)
- [feature/doc-coord-...] README, anexos, introduccion.md, templates y coordinación.
  PR: [#7](https://github.com/FacundoGuiraldes/SistemaTurnosMedicos/pull/N) - @ValeriaMSilva (Documentador y Coordinador)