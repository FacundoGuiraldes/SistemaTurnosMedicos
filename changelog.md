...
### Fixed
- [fix/rc1-documentacion-ia-cu] Corrección de contenido en documentación IA de Casos de Uso. PR: [#XX](link) - @ValeriaMSilva (Modelador de Diagramas de Casos de Uso)
